// Q3: Create a to-do list program using a List where each item has a description, due date, and completion status (as bool).
...
void main() {
  ...
  switch (operation) {
    case 'add':
      print('Type your new description');
      String description = stdin.readLineSync()!;
      tasks.description = description;
      print('Type your new due date');
